  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        url: "/guards/profiles",
        parentKey: "guards",
        capabilityKey: "guards:profiles:view",
      },
      {
        key: "guards-schedules",
        label: "Schedules & Shifts",
        url: "/guards/schedules",
        parentKey: "guards",
        capabilityKey: "guards:schedules:view",
      },
      {
        key: "guards-assignments",
        label: "Community Assignments",
        url: "/guards/assignments",
        parentKey: "guards",
        capabilityKey: "guards:assignments:view",
      },
      {
        key: "guards-equipment",
        label: "Equipment Management",
        url: "/guards/equipment",
        parentKey: "guards",
        capabilityKey: "guards:equipment:view",
      },
      {
        key: "guards-performance",
        label: "Performance",
        url: "/guards/performance",
        parentKey: "guards",
        capabilityKey: "guards:performance:view",
      },
      {
        key: "guards-training",
        ...
        url: "/guards/training",
        parentKey: "guards",
        capabilityKey: "guards:training:view",
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        url: "/agency/profiles",
        parentKey: "agency",
        capabilityKey: "agency:profiles:view",
      },
      {
        key: "agency-staff-management",
        label: "Staff Management",
        url: "/agency/staff",
        parentKey: "agency",
        capabilityKey: "agency:staff:view",
      },
      {
        key: "agency-services-management",
        label: "Services Management",
        url: "/agency/services",
        parentKey: "agency",
        capabilityKey: "agency:services:view",
      },
      {
        key: "agency-finance-billing",
        label: "Finance & Billing",
        url: "/agency/finance",
        parentKey: "agency",
        capabilityKey: "agency:finance:view",
      },
      {
        key: "agency-documents-records",
        label: "Documents & Records",
        url: "/agency/documents",
        parentKey: "agency",
        capabilityKey: "agency:documents:view",
      },
    ],
  },
  {
