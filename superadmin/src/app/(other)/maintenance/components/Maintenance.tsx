                    ...
                    <div className="p-4">
                      <div className="mx-auto mb-5 text-center auth-logo">
                        <Link
                          ...
                          className="logo-dark"
                        >
                          <Image src={logoDark} width={120} height={32} alt="logo dark" />
                        </Link>
                        <Link
                          href="/dashboards/analytics"
                          className="logo-light"
                        >
                          <Image src={logoLight} width={100} height={28} alt="logo light" />
                        </Link>
                      </div>
                      ...
                      <p className="text-muted text-center mt-1 mb-4">
                        We&apos;re making the system more awesome. We&apos;ll be
                        back shortly.
                      </p>
