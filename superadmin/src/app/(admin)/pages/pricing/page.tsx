  ...
  return (
    <Card className="card-pricing">
      <CardBody className="rounded-top text-center bg-gradient bg-primary">
        ...
        <h5 className="mt-0 mb-3 fs-14 text-uppercase fw-semibold text-white">
          {name}
        </h5>
        <h2 className="mt-0 mb-0 fw-bold text-white">
          ${price}{" "}
          <span className="fs-14 fw-medium text-white text-opacity-50">
            / Month
          </span>
        </h2>
      </CardBody>
        ...
        <Col xxl={11}>
          <div className="text-center my-4">
            ...
            <p className="text-muted text-center">
              Get the power and control you need to manage your
              organization&apos;s technical documentation
            </p>
          </div>
