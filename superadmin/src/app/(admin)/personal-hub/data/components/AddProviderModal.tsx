...
const AddProviderModal: React.FC<AddProviderModalProps> = ({ 
  ...
  const [providerData, setProviderData] = useState({
    ...
    coverage_areas: editProvider?.coverage_areas || '',
    supported_networks: editProvider?.supported_networks || '',
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>
          {editProvider ? `Edit Provider: ${editProvider.name}` : 'Add Data Provider'}
        </Modal.Title>
      </Modal.Header>
      ...
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <Modal.Body>
            ...
            <Col md={12}>
              <Form.Group controlId="coverageAreas">
                ...
                <Form.Control
                  ...
                  onChange={handleChange}
                  placeholder="e.g. Nationwide, Regional, International"
                />
                <Form.Text className="text-muted">
                  Comma-separated list of areas where this provider offers service
                </Form.Text>
              </Form.Group>
            </Col>
          </Row>
          ...
          <Row className="mb-3">
            <Col md={12}>
              <Form.Group controlId="supportedNetworks">
                <Form.Label>Supported Networks</Form.Label>
                <Form.Control
                  type="text"
                  name="supported_networks"
                  value={providerData.supported_networks}
                  onChange={handleChange}
                  placeholder="e.g. 4G, 5G, LTE"
                />
                <Form.Text className="text-muted">
                  Comma-separated list of network types supported by this provider
                </Form.Text>
              </Form.Group>
            </Col>
          </Row>
