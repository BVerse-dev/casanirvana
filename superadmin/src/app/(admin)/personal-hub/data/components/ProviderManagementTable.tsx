...
// Reusing modals from airtime services since they have similar functionality
import TopUpBalanceModal from '../../airtime/components/TopUpBalanceModal';
import ProviderDetailsModal from '../../airtime/components/ProviderDetailsModal';
import StatusChangeModal from '../../airtime/components/StatusChangeModal';

// This component reuses the same structure as the airtime provider management table
// but it's specifically for data service providers
...
const ProviderManagementTable = () => {
  ...
  const handleTopUpConfirmation = async (providerId: string, amount: number, method: string) => {
    ...
    alert(`Successfully topped up $${amount} for data provider ${providerId}`);
  };
  ...
  const handleStatusChangeConfirmation = async (providerId: string, status: string, reason: string) => {
    ...
    alert(`Successfully changed data provider status to ${status}`);
  };
