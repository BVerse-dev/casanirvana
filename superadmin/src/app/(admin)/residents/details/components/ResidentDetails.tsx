        ...
        <Card className="bg-light-subtle overflow-hidden z-1">
          <CardBody>
            <div className="d-flex align-items-center gap-2 mb-3">
              {resident.avatar_url ? (
                <Image 
                  src={mapAvatarUrl(resident.avatar_url) || ''} 
                  alt="avatar" 
                ...
                <div className="avatar-md rounded-circle bg-light-subtle d-flex align-items-center justify-content-center">
                  <IconifyIcon icon="ri:user-line" className="fs-18" />
                </div>
              )}
              <div className="d-block">
                <h5 className="text-dark fw-medium">{resident.full_name}</h5>
                <p className=" mb-0 fw-medium">Resident #{resident.id}</p>
              </div>
            ...
            <div className="mt-4">
              <h5 className="text-dark mb-0">
                ...
                Active Resident Since {resident.created_at ? new Date(resident.created_at).getFullYear() : 'Unknown'}
              </h5>
            </div>
          </CardBody>
        </Card>
        <Card>
          ...
          <CardBody>
            <Carousel indicators={false}>
              ...
              <CarouselItem className="carousel-item">
                <Image src={properties4} width={400} height={305} className="d-block w-100 rounded" alt="img-5" />
                <div className="carousel-caption d-none d-md-block bg-light rounded p-2 text-start">
                  <div className="d-flex align-items-center gap-2">
                    <div className="avatar bg-primary rounded flex-centered">
              ...
              <CarouselItem className="carousel-item">
                <Image src={properties5} width={400} height={305} className="d-block w-100 rounded" alt="img-5" />
                <div className="carousel-caption d-none d-md-block bg-light rounded p-2 text-start">
                  <div className="d-flex align-items-center gap-2">
                    <div className="avatar bg-primary rounded flex-centered">
                      <IconifyIcon icon="solar:home-bold-duotone" width={24} height={24} className="fs-24 text-white" />
        ...
        <Card>
          ...
          <CardBody>
            ...
            <div className="d-flex align-items-center bg-light justify-content-between p-3 rounded">
              <div>
                <h5 className="fw-medium mb-1 text-dark">{resident.societies?.name || 'Casa Nirvana Society'}</h5>
                <p className="mb-2">Unit {resident.units?.block}-{resident.units?.number} | {resident.societies?.name || 'Society Location'}</p>
                <div className="d-flex gap-2 align-items-center">
                  ...
                  <p className="mb-0 fw-medium fs-15 text-dark">
                    4.5 <span className="text-muted fs-13">(Society Rating)</span>
                  </p>
                </div>
              </div>
              <div>
