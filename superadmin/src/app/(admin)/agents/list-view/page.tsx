...
export const metadata: Metadata = { title: 'Users List' }

const ListViewPage = () => {
  return (
    <>
      <PageTitle subName="Casa Nirvana" title="Users List" />
      <Row>
        <Col lg={12}>
          <Card>
                  ...
                  <Row className="align-items-center">
                    <Col lg={6}>
                      <form className="app-search d-none d-md-block me-auto">
                        <div className="position-relative">
                          <input type="search" className="form-control" placeholder="Search Users" autoComplete="off" />
                    ...
                    <Col lg={4}>
                      <h5 className="text-dark fw-medium mb-0">
                        311 <span className="text-muted"> Users</span>
                      </h5>
                    </Col>
                  </Row>
                </Col>
                <Col lg={6}>
                  <div className="text-md-end mt-3 mt-md-0">
                    ...
                    <button type="button" className="btn btn-success me-1">
                      <IconifyIcon icon="ri:add-line" /> New User
                    </button>
                  </div>
                </Col>
              </Row>
