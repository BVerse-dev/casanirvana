...
import { Card as BSCard, CardBody, CardHeader, CardTitle, Carousel, CarouselItem, Col, Row, Dropdown, DropdownItem, DropdownMenu, DropdownToggle, Button } from 'react-bootstrap'
import AgencyDetailsCard from './AgencyDetailsCard'
import { getAgencyPropertyImage } from '@/utils/avatarMapper'

const ReactApexChart = dynamic(() => import('react-apexcharts'), { 
  ssr: false,
  loading: () => <div className="d-flex justify-content-center align-items-center" style={{height: '150px'}}>Loading chart...</div>
})

// Agency Activity Chart Data
const agencyActivityChart: ApexOptions = {
  chart: {
    type: "area" as const,
    height: 150,
    sparkline: {
  ...
  series: [
    {
      data: [15, 38, 25, 45, 32, 28, 40, 35, 29, 36, 41],
    },
  ],
  stroke: {
    width: 2,
...
// Sample agency data for the details page - updated for property management
const sampleAgency = {
  id: 'AG001',
  ...
  is_active: true,
  managed_societies: 12,
  total_units: 1840,
  rating: 4.8,
  monthly_revenue: '$485K',
  avg_occupancy: 94,
  founded: '2015-03-12',
  staff_count: 24
};

const AgencyDetails = ({ agency }: { agency?: any }) => {
  ...
  return (
    <Row className="justify-content-center">
      ...
      <Col xl={4} lg={12}>
        <BSCard className="bg-light-subtle overflow-hidden z-1">
          <CardBody>
            <div className="d-flex align-items-center gap-2 mb-3">
              {agencyAvatar ? (
                <Image src={agencyAvatar} width={48} height={48} alt="agency-avatar" className="avatar-md rounded-circle" />
              ) : (
                <div className="avatar-md bg-primary rounded-circle d-flex align-items-center justify-content-center">
                  <IconifyIcon icon="ri:building-4-line" className="fs-18 text-white" />
                </div>
              )}
              <div className="d-block">
                <h5 className="text-dark fw-medium">{agency?.name || 'Agency Name'}</h5>
            ...
            <div className="mt-4">
              <h5 className="text-dark mb-0">
                <IconifyIcon icon="ri:building-3-fill" className="fs-24 text-primary align-middle" /> $485K Management Revenue This Month
              </h5>
            </div>
          </CardBody>
        </BSCard>
        <BSCard>
          <CardHeader>
            <CardTitle as="h4">Managed Society Photos</CardTitle>
          </CardHeader>
          <CardBody>
            <Carousel indicators={false}>
              <CarouselItem className="carousel-item active">
                <Image src={properties1} width={400} height={305} className="d-block w-100 rounded" alt="img-6" />
              ...
              <CarouselItem className="carousel-item">
                <Image src={properties2} width={400} height={305} className="d-block w-100 rounded" alt="img-7" />
                <div className="carousel-caption d-none d-md-block bg-light rounded p-2 text-start">
                  <div className="d-flex align-items-center gap-2">
                    <div className="avatar bg-primary rounded flex-centered">
                      <IconifyIcon icon="solar:buildings-3-bold-duotone" width={24} height={24} className="fs-24 text-white" />
              ...
              <CarouselItem className="carousel-item">
                <Image src={properties3} width={400} height={305} className="d-block w-100 rounded" alt="img-5" />
                <div className="carousel-caption d-none d-md-block bg-light rounded p-2 text-start">
                  <div className="d-flex align-items-center gap-2">
                    <div className="avatar bg-primary rounded flex-centered">
                      <IconifyIcon icon="solar:buildings-3-bold-duotone" width={24} height={24} className="fs-24 text-white" />
              ...
              <CarouselItem className="carousel-item">
                <Image src={properties4} width={400} height={305} className="d-block w-100 rounded" alt="img-8" />
                <div className="carousel-caption d-none d-md-block bg-light rounded p-2 text-start">
                  <div className="d-flex align-items-center gap-2">
                    <div className="avatar bg-primary rounded flex-centered">
                      <IconifyIcon icon="solar:buildings-3-bold-duotone" width={24} height={24} className="fs-24 text-white" />
                    ...
                    <div>
                      ...
                      <p className="text-muted mb-0">1205 , Elk City, OK 73644</p>
                    </div>
                  </div>
                </div>
              </CarouselItem>
              <CarouselItem className="carousel-item">
                <Image src={properties5} width={400} height={305} className="d-block w-100 rounded" alt="img-9" />
                <div className="carousel-caption d-none d-md-block bg-light rounded p-2 text-start">
                  <div className="d-flex align-items-center gap-2">
                    <div className="avatar bg-primary rounded flex-centered">
                      <IconifyIcon icon="solar:buildings-3-bold-duotone" width={24} height={24} className="fs-24 text-white" />
                    ...
                    <div>
                      ...
                      <p className="text-muted mb-0">45, Garden State Parkway NJ</p>
                    </div>
                  </div>
                </div>
              </CarouselItem>
        ...
        <BSCard>
          <CardHeader>
            <CardTitle as={'h5'}>Send Quick Message</CardTitle>
          </CardHeader>
          <CardBody>
            <div>
              <div className="text-center mb-3">
                <div className="avatar-lg bg-primary-subtle rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center">
                  <IconifyIcon icon="ri:message-3-line" className="fs-24 text-primary" />
                </div>
                <h6 className="text-dark mb-2">Contact {agency?.name || 'Agency'}</h6>
                <p className="text-muted small mb-3">Send a quick message to the property management team</p>
              </div>
        ...
        <BSCard>
          <CardHeader>
            <CardTitle as={'h5'}>Recent Management Activities</CardTitle>
          </CardHeader>
          <CardBody>
            <div className="d-flex align-items-start gap-3 mb-3">
              <div className="avatar-sm bg-success-subtle rounded-circle d-flex align-items-center justify-content-center">
                <IconifyIcon icon="ri:tools-line" className="text-success" />
              </div>
              <div className="flex-1">
                <h6 className="mb-1">Maintenance Project Completed</h6>
                <p className="text-muted mb-1 fs-13">Elevator modernization completed at Oakwood Heights</p>
            ...
            <div className="d-flex align-items-start gap-3 mb-3">
              ...
              <div className="flex-1">
                <h6 className="mb-1">New Society Added to Portfolio</h6>
                <p className="text-muted mb-1 fs-13">Paradise Gardens - 150 units now under management</p>
            ...
            <div className="d-flex align-items-start gap-3 mb-3">
              <div className="avatar-sm bg-info-subtle rounded-circle d-flex align-items-center justify-content-center">
                <IconifyIcon icon="ri:group-line" className="text-info" />
              </div>
              <div className="flex-1">
                <h6 className="mb-1">Society AGM Conducted</h6>
                <p className="text-muted mb-1 fs-13">Annual general meeting held for Silver Oak Apartments</p>
            ...
            <div className="d-flex align-items-start gap-3">
              <div className="avatar-sm bg-warning-subtle rounded-circle d-flex align-items-center justify-content-center">
                <IconifyIcon icon="ri:home-line" className="text-warning" />
              </div>
              <div className="flex-1">
                <h6 className="mb-1">Occupancy Rate Improved</h6>
                <p className="text-muted mb-1 fs-13">Marina Bay Towers reached 98% occupancy this month</p>
        ...
        <BSCard>
          <CardHeader>
            <CardTitle as={'h5'}>Monthly Management Performance</CardTitle>
          </CardHeader>
          <CardBody>
            <div className="row text-center">
              <div className="col-6">
                <div className="mb-3">
                  ...
                  <p className="text-muted mb-0">Maintenance Requests Completed</p>
                </div>
              </div>
              <div className="col-6">
                <div className="mb-3">
                  <h4 className="text-primary">$485K</h4>
                  <p className="text-muted mb-0">Management Revenue</p>
                </div>
              </div>
              <div className="col-6">
                <div className="mb-3">
                  <h4 className="text-warning">16</h4>
                  <p className="text-muted mb-0">Society Meetings</p>
                </div>
              </div>
              <div className="col-6">
                <div className="mb-0">
                  <h4 className="text-info">94%</h4>
                  <p className="text-muted mb-0">Average Occupancy</p>
                </div>
              </div>
            </div>
          </CardBody>
        ...
        <BSCard>
          <CardHeader>
            <CardTitle as={'h5'}>Management Resources</CardTitle>
          </CardHeader>
          <CardBody>
            <div className="d-flex align-items-start gap-3 mb-3">
              <div className="avatar-sm bg-primary-subtle rounded-circle d-flex align-items-center justify-content-center">
                <IconifyIcon icon="ri:team-line" className="text-primary" />
              </div>
              <div className="flex-1">
                <h6 className="mb-1">Management Team</h6>
                <p className="text-muted mb-1 fs-13">24 certified property management professionals</p>
                <small className="text-success">All licensed & trained</small>
              </div>
            </div>

            <div className="d-flex align-items-start gap-3 mb-3">
              <div className="avatar-sm bg-success-subtle rounded-circle d-flex align-items-center justify-content-center">
                <IconifyIcon icon="ri:settings-2-line" className="text-success" />
              </div>
              <div className="flex-1">
                <h6 className="mb-1">Maintenance Network</h6>
                <p className="text-muted mb-1 fs-13">24/7 emergency response and vendor network</p>
                <small className="text-success">Always available</small>
              </div>
            </div>

            <div className="d-flex align-items-start gap-3 mb-3">
              <div className="avatar-sm bg-warning-subtle rounded-circle d-flex align-items-center justify-content-center">
                <IconifyIcon icon="ri:smartphone-line" className="text-warning" />
              </div>
              <div className="flex-1">
                <h6 className="mb-1">Digital Management Platform</h6>
                <p className="text-muted mb-1 fs-13">Resident portal and mobile app for all services</p>
                <small className="text-success">Latest technology</small>
              </div>
            </div>

            <div className="d-flex align-items-start gap-3">
              <div className="avatar-sm bg-info-subtle rounded-circle d-flex align-items-center justify-content-center">
                <IconifyIcon icon="ri:customer-service-2-line" className="text-info" />
              </div>
              <div className="flex-1">
                <h6 className="mb-1">Resident Support</h6>
                <p className="text-muted mb-1 fs-13">24/7 resident services and community support</p>
                <small className="text-success">Always available</small>
              </div>
            </div>
          </CardBody>
        ...
        <BSCard>
          <CardHeader>
            <CardTitle as={'h5'}>Management Services</CardTitle>
          </CardHeader>
          <CardBody>
            <div className="d-flex justify-content-between align-items-center mb-3 p-2 bg-light-subtle rounded">
              <div>
                <h6 className="mb-1">Residential Communities</h6>
                <small className="text-muted">Apartment complexes and housing societies</small>
              </div>
            ...
            <div className="d-flex justify-content-between align-items-center mb-3 p-2 bg-light-subtle rounded">
              <div>
                <h6 className="mb-1">Commercial Properties</h6>
                <small className="text-muted">Office buildings and retail complexes</small>
              </div>
              <span className="badge bg-success">Active</span>
            </div>
            ...
            <div className="d-flex justify-content-between align-items-center mb-3 p-2 bg-light-subtle rounded">
              <div>
                <h6 className="mb-1">Maintenance Services</h6>
                <small className="text-muted">24/7 emergency and scheduled maintenance</small>
              </div>
              <span className="badge bg-success">Active</span>
            </div>
            ...
            <div className="d-flex justify-content-between align-items-center p-2 bg-light-subtle rounded">
              <div>
                <h6 className="mb-1">Amenity Management</h6>
                <small className="text-muted">Swimming pools, gyms, and common areas</small>
              </div>
              <span className="badge bg-success">Specialty</span>
            </div>
          </CardBody>
        </BSCard>
      </Col>
