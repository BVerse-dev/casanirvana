...
const PaymentDetailsEnhanced = ({ payment }: PaymentDetailsProps) => {
            ...
            <CardBody>
              <Row>
                ...
                {payment.completed_at && (
                  <Col md={6}>
                    <div className="mb-4">
                      <h6 className="text-muted mb-1">Completed At</h6>
                      <p className="mb-0 fw-medium">
                ...
                {payment.failed_at && (
                  <Col md={6}>
                    <div className="mb-4">
                      <h6 className="text-muted mb-1">Failed At</h6>
                      <p className="mb-0 fw-medium">
                ...
                <Col md={6}>
                  <div className="mb-4">
                    ...
                    <p className="mb-0 fw-medium">{payment.payment_type || "N/A"}</p>
                  </div>
                </Col>
                <Col md={6}>
                  <div className="mb-4">
                    <h6 className="text-muted mb-1">Society</h6>
                    <p className="mb-0 fw-medium">
                      {payment.society?.name ? (
                        ...
                        >
                          <IconifyIcon 
                            ...
                            className="me-1 text-primary fs-16" 
                          />
                          {payment.society.name}
                        </Link>
                      ) : (
                ...
                <Col md={12}>
                  <div className="mb-4">
                    ...
                    <p className="mb-0 fw-medium">{payment.description || "No description available"}</p>
                  </div>
                </Col>
                {payment.notes && (
                  <Col md={12}>
                    <div className="mb-4">
                      ...
                      <p className="mb-0 fw-medium">{payment.notes}</p>
                    </div>
                  </Col>
                )}
              </Row>
              ...
              <div className="bg-light-subtle p-4 rounded mb-4">
                <Row className="align-items-center">
                  <Col xs={6}>
                    ...
                    <p className="text-muted mb-0">{payment.payment_type || "Payment"} Total</p>
                  </Col>
