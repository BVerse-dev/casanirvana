...
const PaymentChargesPage = () => {
  ...
  return (
    <>
      <PageTitle title="Payment Charges" subName="Charge Catalog, Issue Runs, and Resident Invoices" />
        ...
        <>
          <Row className="g-3 mb-3">
            <Col xl={5}>
              <Card className="h-100">
                <Card.Header className="d-flex justify-content-between align-items-center">
                  <div>
                    <h5 className="mb-0">{editingTemplateId ? 'Edit Charge Template' : 'Create Charge Template'}</h5>
                    <small className="text-muted">Templates define recurring or one-time resident charges.</small>
                  </div>
                  {editingTemplateId && (
                  ...
                  <Row className="g-3">
                    ...
                    <Col md={6}>
                      <Form.Group>
                        ...
                        <Form.Select
                          value={templateForm.catalog_key}
                          onChange={(event) => setCatalogDefaults(event.target.value)}
                        >
                          {catalog.map((item) => (
                    ...
                    <Col md={6}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          onChange={(event) => handleTemplateChange('category', event.target.value)}
                        />
                      </Form.Group>
                    </Col>
                    <Col md={6}>
                    ...
                    <Col md={12} className="d-flex gap-2 justify-content-end">
                      ...
                      >
                        {createTemplate.isPending || updateTemplate.isPending ? 'Saving...' : editingTemplateId ? 'Update Template' : 'Create Template'}
                      </Button>
                    </Col>
                  </Row>
                </Card.Body>
            ...
            <Col xl={7}>
              <Card className="h-100">
                <Card.Header>
                  <h5 className="mb-0">Preview and Issue Charges</h5>
                  <small className="text-muted">Generate a resident invoice batch before issuing obligations into the user app.</small>
                </Card.Header>
                <Card.Body>
                  <Row className="g-3">
                    <Col md={6}>
                      <Form.Group>
                        <Form.Label>Charge Template</Form.Label>
                        <Form.Select
                    ...
                    <Col md={6}>
                      <Form.Group>
                        ...
                        <Form.Select
                          ...
                          onChange={(event) =>
                            setPreviewForm((current) => ({ ...current, community_id: event.target.value }))
                          }
                    ...
                    <Col md={4}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          onChange={(event) =>
                            setPreviewForm((current) => ({ ...current, billing_period_start: event.target.value }))
                          }
                        />
                      </Form.Group>
                    </Col>
                    <Col md={4}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          onChange={(event) =>
                            setPreviewForm((current) => ({ ...current, billing_period_end: event.target.value }))
                          }
                        />
                      </Form.Group>
                    </Col>
                    <Col md={4}>
                      <Form.Group>
                        ...
                        <Form.Control
                          ...
                          onChange={(event) =>
                            setPreviewForm((current) => ({ ...current, due_date: event.target.value }))
                          }
                        />
                      </Form.Group>
                    </Col>
                        ...
                        <Row className="g-3 mb-3">
                          <Col md={4}>
                            <div className="border rounded p-2">
                              ...
                              <div>{formatDate(previewData.billing_period_start)} - {formatDate(previewData.billing_period_end)}</div>
                            </div>
                          </Col>
                          <Col md={4}>
                            <div className="border rounded p-2">
                            ...
                            <tbody>
                              {previewData.items.map((item) => (
                                <tr key={`${item.unit_id}-${item.invoice_number}`}>
                                  ...
                                  <td>
                                    {item.existing_obligation_id ? (
                                      <Badge bg="secondary">Already Issued</Badge>
                                    ) : (
          ...
          <Row className="g-3 mb-3">
            <Col xl={7}>
              <Card className="h-100">
                <Card.Header>
                  <h5 className="mb-0">Charge Templates</h5>
                  <small className="text-muted">Recurring and one-time fee definitions for agencies and communities.</small>
                </Card.Header>
                <Card.Body>
                          ...
                          <tr key={template.id}>
                            ...
                            <td>
                              ...
                              <small className="text-muted">
                                {template.community?.name || template.agency?.name || '—'}
                              </small>
                            </td>
            ...
            <Col xl={5}>
              <Card className="h-100">
                <Card.Header>
                  <h5 className="mb-0">Fee / Charge Catalog</h5>
                  <small className="text-muted">Seeded HOA, utility, service, penalty, and assessment charge types.</small>
                </Card.Header>
                <Card.Body>
                  <div className="table-responsive" style={{ maxHeight: 520 }}>
                    <Table hover className="align-middle mb-0">
          ...
          <Row className="g-3">
            <Col xl={7}>
              <Card className="h-100">
                <Card.Header>
                  <h5 className="mb-0">Charge Runs and Invoices</h5>
                  <small className="text-muted">Every issued run creates scoped resident obligations and invoice numbers in the user app.</small>
                </Card.Header>
                <Card.Body>
                        ...
                        {runs.map((run) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td>
                                <Badge bg={run.status === 'issued' ? 'success' : run.status === 'cancelled' ? 'secondary' : 'warning'}>
                                  {run.status}
                                </Badge>
                              </td>
            ...
            <Col xl={5}>
              <Card className="h-100">
                <Card.Header>
                  ...
                  <small className="text-muted">Resident obligations generated for the selected charge run.</small>
                </Card.Header>
                <Card.Body>
                  {!selectedRunId ? (
                    <Alert variant="light" className="mb-0">
                      Select a run to inspect the issued invoices and resident obligations.
                    </Alert>
                    ...
                    <>
                      <div className="mb-3">
                        <div className="fw-semibold">{runDetailQuery.data?.run?.template?.name || 'Charge Run'}</div>
                        <small className="text-muted">{runDetailQuery.data?.run?.community?.name || 'Community'}</small>
                      </div>
                      <div className="table-responsive" style={{ maxHeight: 360 }}>
                        <Table hover className="align-middle mb-0">
                          ...
                          <tbody>
                            {(runDetailQuery.data?.obligations || []).map((obligation: Record<string, any>) => (
                              <tr key={obligation.id}>
                                ...
                                <td>
                                  <Badge bg={obligation.status === 'paid' ? 'success' : obligation.status === 'overdue' ? 'danger' : 'warning'}>
                                    {obligation.status}
                                  </Badge>
                                </td>
