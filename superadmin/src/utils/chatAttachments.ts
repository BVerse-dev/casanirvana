...
type ChatAttachmentInput = Record<string, any> | null | undefined;
...
export const inferChatAttachmentType = (
...
export const normalizeChatAttachment = (
  ...
  const fileName =
    ...
    attachment.name ||
    attachment.filename ||
    (path ? String(path).split("/").pop() : "Attachment");
...
export const hydrateMessageChatAttachment = async (storageClient: any, message: any) => {
...
export const hydrateChatAttachments = async (storageClient: any, messages: any[] = []) =>
