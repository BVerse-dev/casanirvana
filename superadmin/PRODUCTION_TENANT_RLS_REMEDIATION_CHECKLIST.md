...
- 2026-03-11: Continued backend error-response normalization by moving the legacy public auth/community/unit/maintenance controllers onto the shared error-handler path and simplifying `/auth/me` to reuse `requireAuth` directly. Full route-by-route normalization remains open in the main backlog.
