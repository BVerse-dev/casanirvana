-- Phase 19 follow-up: make chat attachments private and align access to
-- message participants plus scoped admins, while keeping group chat usable for admins.
...
create policy p19_chat_attachments_select_scoped
on storage.objects
for select
to authenticated
using (
