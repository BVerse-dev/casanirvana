...
const PinCodeScreen = ({ navigation }) => {
    ...
    <View style={styles.inputContainer}>
      ...
      <View style={styles.inputWrapper}>
        ...
        <TouchableOpacity onPress={() => setShowPin(!showPin)} style={styles.eyeIcon}>
          <Ionicons name={showPin ? 'eye-outline' : 'eye-off-outline'} size={20} color={Colors.grey} />
        </TouchableOpacity>
      </View>
    </View>
  );
  ...
  return (
    <View style={{ flex: 1, backgroundColor: Colors.extraLightGrey }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingVertical: Default.fixPadding * 2 }}>
        <View style={styles.container}>
          ...
          <View style={styles.formSection}>
            {pinInputField('Current PIN', currentPin, setCurrentPin, showCurrentPin, setShowCurrentPin, 'Enter current PIN')}
            {pinInputField('New PIN', newPin, setNewPin, showNewPin, setShowNewPin, 'Enter new PIN')}
            {pinInputField('Confirm New PIN', confirmPin, setConfirmPin, showConfirmPin, setShowConfirmPin, 'Confirm new PIN')}
          </View>
