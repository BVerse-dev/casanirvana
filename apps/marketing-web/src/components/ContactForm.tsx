  ...
  return (
    <form className="pxl-contact-form-3" onSubmit={submit} noValidate>
      <div className="pxl-form-grid">
        ...
        <label><span>Reason for enquiry</span><select name="reason" defaultValue="" aria-invalid={Boolean(errors.reason)}><option value="" disabled>Reason for enquiry</option><option>Book a demo</option><option>Community onboarding</option><option>Partnership</option><option>Support</option><option>General enquiry</option></select>{errors.reason ? <small>{errors.reason}</small> : null}</label>
      </div>
