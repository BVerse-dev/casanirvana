...
const routeTransforms = {
  ...
  "/pricing-plans/": {
    replacements: [
      ...
      ["Free", "Contact-led"],
      ["For personal use & explanation of AI technology thing.", "A focused starting scope for core resident, visitor and gate workflows."],
      ...
      ["Custom Integrations", "Integration discovery and scoping"],
      ["Project & Task Management", "Onboarding and rollout planning"],
      ["Business Analytics & Insights", "Operational status visibility"],
      ["Real-Time AI Insights", "Realtime in-app updates"],
      ["Support", "Support scope"],
  ...
  "/core-features/": {
    replacements: [
      ...
      ["14-day trial,\n\tno credit card required.", "A guided rollout shaped around your community's requirements."],
      ["AI-based customer\n\tservice platform built for", "Connected community operations built for"],
      ["Calendar", "Amenities"],
      ["Analytics", "Requests"],
      ["Invoices", "Payments"],
      ["built with calendar", "built around community workflows"],
      ["SaaS & app\n\tsolutions offer a comprehensive", "Casa Nirvana products share a connected"],
      ["Automation & workflow features include a drag & drop builder, automated task assignments, conditional with good triggers, and api integrations.", "Visitor passes, requests, notices, bookings, marketplace activity and configured services share role-aware records."],
      ...
      ["Input Data", "Join your community"],
      ["Upload or connect your data sources seamlessly.", "Authorized residents and teams enter through community-scoped onboarding and membership workflows."],
      ["Code-wise syncing", "Connected records"],
      ["Automation & workflow features include a drag & drop builder, automated task assignments, conditional with good triggers, and api integrations will be ready.", "Visitor, request, booking, payment and communication activity remains associated with the correct community context."],
      ["Easy deployments", "Role-focused experiences"],
      ["Deploy with just a few clicks. No complex setup required — automated from build to production, with CI/CD support and safe rollbacks.", "Residents, guards and managers receive focused interfaces for the actions and information permitted by their roles."],
      ...
      ["“ Working with Silver feels like a partnership; as we continued to use their tool and found more use cases. ”", "One community context connects visitor operations, resident services, guard activity and facility oversight."],
      ["Mateo R. Albright", "Casa Nirvana"],
      ["/CEO", "/Product principles"],
      ...
      ["Automatically jump into a dedicated Slack channel and we’ll provide.", "Enable the supported modules and roles needed for rollout."],
      ...
      ["Get answers\n\tto every single question.", "Understand how Casa Nirvana supports each community role."],
      ...
      ["What design principles will you follow?", "What design principles guide Casa Nirvana?"],
      ...
      ["Equity doesn't have to be complicated.", "Community operations do not need to remain fragmented."],
      ["try for free", "plan your rollout"],
  ...
  "/faqs/": {
    replacements: [
      ...
      ["Payment gateways, CRM platforms, cloud storage, marketing tools, and project management software for seamless business workflows.", "Only configured backend payment and digital-service integrations are included at launch. Availability depends on live provider and community settings."],
      ...
      ["User retention, engagement, churn rate, revenue growth, customer satisfaction, and feature adoption rates.", "Authorized teams can follow recorded status across visitors, requests, bookings, payments and orders without unsupported performance guarantees."],
      ...
      ["mailto:info@saliver.com", "mailto:hello@casanirvana.com"],
      ["info@saliver.com", "hello@casanirvana.com"],
