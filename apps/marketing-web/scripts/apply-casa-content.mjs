...
const routeTransforms = {
  ...
  "/faqs/": {
    ...
    replacements: [
      ...
      ['href="/404-error"', 'href="/contact-us/"'],
      [">404</span>", ">Contact</span>"],
      ['href="#">Get in touch</a>', 'href="/contact-us/">Get in touch</a>'],
      ['href="#">getting started</a>', 'href="/our-products/">product overview</a>'],
      ['<a class="pxl-item--link" href="">One</a>', '<span class="pxl-item--link">One</span>'],
      ["+(123) 456 789 00", "Email enquiries"],
      ["Saliver Creative", "Casa Nirvana"],
      ["123 Coly new road, Horwich", "Accra"],
      ["Bolton, BL7 9QN", "Ghana"],
