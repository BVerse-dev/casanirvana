...
const AboutAppScreen = ({ navigation }) => {
  ...
  const openWebsite = () => {
    Alert.alert(
      "Visit Website",
      "This will open our website in your browser.",
      [
        { text: "Cancel", style: "cancel" },
        { text: "Open", onPress: () => console.log("Opening website...") },
      ]
    );
  };
  ...
  const shareApp = () => {
    Alert.alert(
      "Share App",
      "Share Casa Nirvana with your friends and neighbors!",
      [
        { text: "Cancel", style: "cancel" },
  ...
  const rateApp = () => {
    Alert.alert(
      "Rate Our App",
      "Enjoying Casa Nirvana? Please rate us in the app store!",
      [
      ...
      >
        ...
        <View style={styles.techSection}>
          ...
          {Object.entries(technicalSpecs).map(([key, value]) => (
            <View key={key} style={styles.techItem}>
              <Text style={styles.techLabel}>{key.charAt(0).toUpperCase() + key.slice(1).replace('_', ' ')}:</Text>
        ...
        <View style={styles.teamSection}>
          ...
          {teamMembers.map((member, index) => (
            <View key={index} style={styles.teamMember}>
              <MaterialCommunityIcons name={member.icon} size={24} color={Colors.primary} />
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                if (item.screen) {
                  ...
                  Alert.alert(item.title, "This document will open in your browser.");
                }
              }}
            >
        ...
        <View style={styles.contactSection}>
          ...
          <TouchableOpacity style={styles.contactItem} onPress={openWebsite}>
            ...
            <View style={styles.contactInfo}>
              ...
              <Text style={styles.contactValue}>casanirvana.app</Text>
            </View>
            <Ionicons name="chevron-forward" size={18} color={Colors.grey} />
          </TouchableOpacity>
