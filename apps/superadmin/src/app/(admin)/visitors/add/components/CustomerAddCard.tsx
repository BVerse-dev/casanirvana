        ...
        <CardBody>
          ...
          <div className="mt-5 pt-3 ms-1">
            <div className="d-flex justify-content-between align-items-center mb-3">
              <h4 className="mb-0 text-dark fw-semibold">Visitor Profile</h4>
              <div>
            ...
            <p className="text-muted fw-medium fs-14 mb-1">
              <span className="text-dark me-1">Pass Type : </span> Daily Visitor
            </p>
            <p className="text-muted fw-medium fs-14 mb-1">
              <span className="text-dark me-1">Valid Until : </span> Today 11:59
              PM
            </p>
            <p className="text-muted fw-medium fs-14 mb-1">
              <span className="text-dark me-1">Gate Entry : </span> Main Gate
            </p>
            <Row className="mt-3 justify-content-between">
              <Col lg={4}>
                <p className="fw-medium mb-2">Visiting Unit</p>
                <h5 className="mb-0 fw-semibold text-dark">A-104</h5>
              </Col>
              <Col lg={4}>
                <p className="fw-medium mb-2">Host Resident</p>
                <h5 className="mb-0 fw-semibold text-dark">John Doe</h5>
              </Col>
              <Col lg={4}>
                <p className="fw-medium mb-2">Visit Count</p>
                <h5 className="mb-0 fw-semibold text-dark">5</h5>
              </Col>
            </Row>
            <h4 className="mt-3 fs-17">Emergency Contact :</h4>
