...
const CommunityAddForm = ({ editMode = false, communityId }: CommunityAddFormProps) => {
  ...
  const { handleSubmit, control, reset, watch } = useForm<CommunityFormData>({
  ...
  React.useEffect(() => {
    ...
    try {
      ...
      reset({
        ...
        society_type: existingCommunity.society_type || "",
        status: (existingCommunity.status as any) || 'active',
        total_units: existingCommunity.total_units == null ? undefined as any : Number(existingCommunity.total_units),
        total_floors: existingCommunity.total_floors == null ? undefined as any : Number(existingCommunity.total_floors),
        total_blocks: existingCommunity.total_blocks == null ? undefined as any : Number(existingCommunity.total_blocks),
        established_year: existingCommunity.established_year == null ? undefined as any : Number(existingCommunity.established_year),
        maintenance_charge: existingCommunity.maintenance_charge == null ? undefined as any : Number(existingCommunity.maintenance_charge),
        security_deposit: existingCommunity.security_deposit == null ? undefined as any : Number(existingCommunity.security_deposit),
        parking_slots: existingCommunity.parking_slots == null ? undefined as any : Number(existingCommunity.parking_slots),
