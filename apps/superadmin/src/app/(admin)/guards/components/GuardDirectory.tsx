...
const GuardDirectory = () => {
  ...
  return (
    <>
      ...
      {view === "grid" ? <GuardDirectoryGrid guards={guards} isLoading={guardsQuery.isLoading} error={error} onDelete={handleDelete} /> : <GuardDirectoryList guards={guards} isLoading={guardsQuery.isLoading} error={error} onDelete={handleDelete} />}
