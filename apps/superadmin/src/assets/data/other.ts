...
export const userData: UserType[] = [
  ...
  // Additional users for drafts to reach count of 8
  {
    id: "10",
    name: "Mark Johnson",
    avatar: avatar1,
    ...
    contact: "+231 90-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(380),
    mutualCount: 25,
    location: "California, USA",
    message: "Draft project proposal...",
    activityStatus: "offline",
    address: "Main Street 123",
    emailMessage: "Project proposal draft needs review...",
    emailFolder: "draft",
    isDraft: true,
  },
  {
    ...
    contact: "+231 91-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(400),
    mutualCount: 67,
    location: "New York, USA",
    message: "Budget report draft...",
    activityStatus: "online",
    address: "Park Avenue 456",
    emailMessage: "Q4 budget report requires finalization...",
    emailFolder: "draft",
    isDraft: true,
  },
  {
    ...
    contact: "+231 92-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(420),
    mutualCount: 89,
    location: "Texas, USA",
    message: "Meeting minutes draft...",
    activityStatus: "typing",
    address: "Oak Street 789",
    emailMessage: "Board meeting minutes need approval...",
    emailFolder: "draft",
    isDraft: true,
  },
  {
    ...
    contact: "+231 93-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(440),
    mutualCount: 34,
    location: "Florida, USA",
    message: "Marketing campaign draft...",
    activityStatus: "offline",
    address: "Sunset Boulevard 321",
    emailMessage: "New marketing strategy draft outline...",
    emailFolder: "draft",
    isDraft: true,
  },
  {
    ...
    contact: "+231 94-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(460),
    mutualCount: 12,
    location: "Washington, USA",
    message: "Contract draft review...",
    activityStatus: "online",
    address: "Capitol Hill 654",
    emailMessage: "Legal contract draft needs validation...",
    emailFolder: "draft",
    isDraft: true,
  },
  {
    ...
    contact: "+231 95-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(480),
    mutualCount: 78,
    location: "California, USA",
    message: "Training manual draft...",
    activityStatus: "offline",
    address: "Beverly Hills 987",
    emailMessage: "Employee training manual draft ready...",
    emailFolder: "draft",
    isDraft: true,
  },
  {
    ...
    contact: "+231 96-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(840),
    mutualCount: 45,
    location: "New York, USA",
    message: "Policy document draft...",
    activityStatus: "online",
    address: "Central Park 234",
    emailMessage: "New HR policy document in progress...",
    emailFolder: "draft",
    isDraft: true,
  },
  // Promotions category (3 emails)
  {
    id: "16",
    name: "Promo Team",
    avatar: avatar7,
    languages: ["English"],
    email: "promotions@company.com",
    contact: "+231 96-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(500),
    mutualCount: 0,
    location: "Marketing Dept",
    message: "Special offer inside...",
    activityStatus: "online",
    address: "Marketing Floor",
    emailMessage: "50% off selected items this weekend...",
    emailFolder: "Promotions",
  },
  {
    id: "17",
    name: "Sales Team",
    ...
    contact: "+231 97-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(520),
    mutualCount: 0,
    location: "Sales Dept",
    message: "Limited time offer...",
    activityStatus: "online",
    address: "Sales Floor",
    emailMessage: "Exclusive deals for premium members...",
    emailFolder: "Promotions",
  },
  {
    id: "18",
    ...
    avatar: avatar9,
    languages: ["English"],
    email: "deals@company.com",
    contact: "+231 98-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(540),
    mutualCount: 0,
    location: "Deals Dept",
    message: "Flash sale notification...",
    activityStatus: "offline",
    address: "Deals Center",
    emailMessage: "Flash sale starts in 2 hours...",
    emailFolder: "Promotions",
  },
  // Updates category (14 emails) - Adding first 10 of 14
  {
    id: "19",
    name: "System Updates",
    avatar: avatar1,
    ...
    contact: "+231 99-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(560),
    mutualCount: 0,
    location: "IT Dept",
    message: "System maintenance scheduled...",
    activityStatus: "online",
    address: "IT Floor",
    emailMessage: "Scheduled maintenance this weekend...",
    emailFolder: "Updates",
  },
  {
    id: "20",
    ...
    contact: "+231 00-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(580),
    mutualCount: 0,
    location: "App Team",
    message: "New feature available...",
    activityStatus: "online",
    address: "Development Floor",
    emailMessage: "New dashboard features released...",
    emailFolder: "Updates",
  },
  {
    id: "21",
    ...
    activityStatus: "offline",
    address: "Security Center",
    emailMessage: "Important security patch available...",
    emailFolder: "Updates",
  },
  {
    id: "22",
    ...
    contact: "+231 02-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(620),
    mutualCount: 0,
    location: "HR Dept",
    message: "Policy changes effective...",
    activityStatus: "online",
    address: "HR Floor",
    emailMessage: "Updated company policies in effect...",
    emailFolder: "Updates",
  },
  {
    id: "23",
    ...
    contact: "+231 03-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(640),
    mutualCount: 0,
    location: "Dev Team",
    message: "New version deployed...",
    activityStatus: "typing",
    address: "Development Center",
    emailMessage: "Application version 2.1.4 deployed...",
    emailFolder: "Updates",
  },
  // Remaining 9 users for Updates to reach 14 total
  {
    id: "24",
    name: "Database Team",
    avatar: avatar6,
    languages: ["English"],
    email: "database@company.com",
    contact: "+231 04-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(660),
    mutualCount: 0,
    location: "Database Dept",
    message: "Database migration complete...",
    activityStatus: "online",
    address: "Database Center",
    emailMessage: "Database schema updated successfully...",
    emailFolder: "Updates",
  },
  {
    id: "25",
    ...
    contact: "+231 05-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(680),
    mutualCount: 0,
    location: "API Team",
    message: "New API endpoints available...",
    activityStatus: "offline",
    address: "API Development",
    emailMessage: "REST API v3.0 endpoints released...",
    emailFolder: "Updates",
  },
  {
    id: "26",
    ...
    contact: "+231 06-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(700),
    mutualCount: 0,
    location: "Performance Dept",
    message: "Performance optimizations deployed...",
    activityStatus: "online",
    address: "Performance Lab",
    emailMessage: "System performance improved by 30%...",
    emailFolder: "Updates",
  },
  {
    id: "27",
    ...
    contact: "+231 07-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(720),
    mutualCount: 0,
    location: "Backup Dept",
    message: "Backup procedures updated...",
    activityStatus: "typing",
    address: "Backup Center",
    emailMessage: "New automated backup system online...",
    emailFolder: "Updates",
  },
  {
    id: "28",
    ...
    contact: "+231 08-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(740),
    mutualCount: 0,
    location: "Monitoring Dept",
    message: "System monitoring enhanced...",
    activityStatus: "online",
    address: "Monitoring Station",
    emailMessage: "Real-time monitoring dashboard updated...",
    emailFolder: "Updates",
  },
  {
    id: "29",
    ...
    contact: "+231 09-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(760),
    mutualCount: 0,
    location: "Docs Team",
    message: "Documentation updated...",
    activityStatus: "offline",
    address: "Documentation Center",
    emailMessage: "User guides and API docs refreshed...",
    emailFolder: "Updates",
  },
  {
    id: "30",
    ...
    contact: "+231 10-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(780),
    mutualCount: 0,
    location: "QA Dept",
    message: "Testing procedures updated...",
    activityStatus: "typing",
    address: "QA Lab",
    emailMessage: "New testing protocols implemented...",
    emailFolder: "Updates",
  },
  {
    id: "31",
    ...
    contact: "+231 11-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(800),
    mutualCount: 0,
    location: "Deploy Dept",
    message: "Deployment pipeline updated...",
    activityStatus: "online",
    address: "Deployment Center",
    emailMessage: "CI/CD pipeline improvements deployed...",
    emailFolder: "Updates",
  },
  {
    id: "32",
    ...
    contact: "+231 12-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(820),
    mutualCount: 0,
    location: "Infra Team",
    message: "Infrastructure scaling complete...",
    activityStatus: "offline",
    address: "Infrastructure Hub",
    emailMessage: "Server infrastructure upgraded...",
    emailFolder: "Updates",
  },
  // Snoozed emails
  {
    ...
    avatar: avatar8,
    languages: ["English"],
    email: "meetings@company.com",
    contact: "+231 13-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(860),
    mutualCount: 0,
    location: "Calendar Dept",
    message: "Snoozed: Weekly team meeting...",
    activityStatus: "online",
    address: "Meeting Room",
    emailMessage: "Weekly team meeting scheduled for tomorrow...",
    emailFolder: "snoozed",
  },
  {
    id: "35",
    ...
    avatar: avatar9,
    languages: ["English"],
    email: "tasks@company.com",
    contact: "+231 14-12345678",
    status: "Active",
    time: addOrSubtractMinutesFromDate(880),
    mutualCount: 0,
    location: "Task Manager",
    message: "Snoozed: Project deadline approaching...",
    activityStatus: "offline",
    address: "Project Hub",
    emailMessage: "Project deadline reminder snoozed until...",
    emailFolder: "snoozed",
  },
  // Additional folders for "More" section
  {
    id: "36",
    name: "Spam Filter",
    avatar: avatar1,
    ...
    contact: "+000 00-00000000",
    status: "Inactive",
    time: addOrSubtractMinutesFromDate(900),
    mutualCount: 0,
    location: "Spam Folder",
    message: "Suspicious email blocked...",
    activityStatus: "offline",
    address: "Blocked Domain",
    emailMessage: "Suspicious activity detected in email...",
    emailFolder: "spam",
  },
  {
    id: "37",
    ...
    contact: "+231 15-12345678",
    status: "Inactive",
    time: addOrSubtractMinutesFromDate(920),
    mutualCount: 0,
    location: "Archive",
    message: "Old project files archived...",
    activityStatus: "offline",
    address: "Archive Storage",
    emailMessage: "Project files have been archived...",
    emailFolder: "archive",
  },
  {
    id: "38",
    ...
    contact: "+231 16-12345678",
    status: "Inactive",
    time: addOrSubtractMinutesFromDate(940),
    mutualCount: 0,
    location: "Trash",
    message: "Email moved to trash...",
    activityStatus: "offline",
    address: "Trash Folder",
    emailMessage: "This email has been deleted...",
    emailFolder: "deleted",
  },
];
