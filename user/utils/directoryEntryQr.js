...
export const resolveDirectoryEntryIdentity = ({ prefix, existingEntryCode, existingQrCode }) => {
...
export const buildFamilyMemberQrCode = ({ entityId, entryCode, data }) => JSON.stringify({
  id: entityId,
  name: data.name,
...
export const buildDailyHelpQrCode = ({ entityId, entryCode, data }) => JSON.stringify({
  id: entityId,
  name: data.name,
  type: data.type,
  phone: data.phone || null,
...
export const buildVehicleQrCode = ({ entityId, entryCode, data }) => JSON.stringify({
  id: entityId,
...
export const buildFrequentEntryQrCode = ({ entityId, entryCode, data }) => JSON.stringify({
  id: entityId,
  name: data.name,
  relation: data.relation,
  phone: data.phone || null,
