...
import { useCommunityCommittee, useCommunityMembersSubscription } from "../hooks/useCommunityMembers";
...
const CommitteeTab = ({ navigation }) => {
  ...
  const { data: committeeList = [], isLoading, error } = useCommunityCommittee();
