...
const TransferRecipientScreen = ({ navigation, route }) => {
  ...
  const handleContinue = () => {
    if (!phoneNumber || phoneNumber.length < 9) {
      Alert.alert(
        ...
        tr("Please enter a valid phone number to continue.")
      );
      return;
    }
        ...
        >
          ...
          <View style={{ 
            ...
            >
              <TextInput
                ...
                placeholder={tr("Recipient phone number")}
            ...
            <TextInput
              ...
              placeholder={tr("Name or description (e.g. Mom)")}
              placeholderTextColor={Colors.grey}
            />
            ...
            >
              <View>
                ...
                <Text style={{ ...Fonts.Medium14grey, marginTop: 2 }}>
                  {tr("Save this recipient for future transfers")}
                </Text>
              </View>
              <Switch
                value={saveRecipient}
                ...
                thumbColor={saveRecipient ? Colors.primary : Colors.white}
          ...
          <View style={{ 
            ...
            <Text style={{ ...Fonts.Medium14black, flex: 1 }}>
              {tr("Enter the recipient's phone number and name. You can save this recipient for future transfers.")}
            </Text>
          </View>
        </ScrollView>
